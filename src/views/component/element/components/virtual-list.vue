 ...
 * @LastEditTime: 2021-08-11 18:05:00
 * @Description:
 * @FilePath: \xia-admin\src\views\component\element\components\virtual-list.vue
-->
<template>
  <el-table
    ref="table"
...
.virtual-table{
  ::v-deep.el-table th {
    background-color: rgba($color: $main-color, $alpha: .12) !important;
